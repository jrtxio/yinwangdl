...
“Talk is cheap. Show me the code.” 这句话出自 Linus Torvalds 在 linux-kernel mailing list 的一个[回帖](https://lkml.org/lkml/2000/8/25/132)。如果你看了我对微内核和线程的[[微内核与宏内核的思考|分析]]，也许会明白 Jamie Lokier 的话其实是有意义的。如果保持开放的心态，继续的探讨也许会给 Linux 内核带来突破性的改进，然而这种可能性却被 Linus 一句“Talk is cheap. Show me the code.” 给扼杀了。

![Pasted image 20231212171158.png](/images/talk-is-not-cheap/Pasted%20image%2020231212171158.png)
