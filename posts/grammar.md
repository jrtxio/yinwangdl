...
![i-eat-apple.png](/images/grammar/i-eat-apple.png)
...
![i-eat-apple-symbol.png](/images/grammar/i-eat-apple-symbol.png)
...
![eat-verb.png](/images/grammar/eat-verb.png)
...
![pronoun-def.png](/images/grammar/pronoun-def.png)
...
_A make B C_ 里的 C 参数，其实就是传统语法叫做“宾语补足语”（宾补）的东西。然而跟传统语法不同，我不把它叫做“宾补”。这个成分没有任何特殊的名字和地位，而只是动词 make 的第三个参数。
...
![i-eat-apple-tree.png](/images/grammar/i-eat-apple-tree.png)
...
![i-eat-fuji-apples-tree.png](/images/grammar/i-eat-fuji-apples-tree.png)
...
![i-sometimes-eat-fuji-apples-tree.png](/images/grammar/i-sometimes-eat-fuji-apples-tree.png)
...
![i-eat-apple-complex-tree.png](/images/grammar/i-eat-apple-complex-tree.png)
...
![i-eat-apples-trunk.png](/images/grammar/i-eat-apples-trunk.png)
